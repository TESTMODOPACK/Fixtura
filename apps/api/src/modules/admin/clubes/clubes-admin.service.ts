...
export class ClubesAdminService {
  ...
  async update(
    ...
    // ADR-0005 — el club es la fuente de verdad: fixture, dashboard y portal
    // leen nombre/escudo/colores directo del club vía la inscripción. Ya no
    // hay equipo sombra que propagar.
