...
import { AlertTriangle, BarChart3, Coins, ShieldOff, Trophy, Users, Wallet } from 'lucide-react';
import {
  Bar,
  BarChart,
  CartesianGrid,
  ...
  return (
    <>
      <PageHead
        ...
        sub="Tendencias de crecimiento, finanzas y disciplina sobre los datos de tu liga. (El módulo de NPS / encuestas llega en la próxima etapa.)"
      />
